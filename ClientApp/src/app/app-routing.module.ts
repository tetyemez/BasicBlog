...
const routes: Routes = [
  { path: '', component: BlogPostsComponent, pathMatch: 'full' }, // Uygulamanın başlayacağı sayfayı belirtir.
  { path: 'blogpost/:id', component: BlogPostComponent },
  { path: 'add', component: BlogPostAddEditComponent },
  { path: 'blogpost/edit/:id', component: BlogPostAddEditComponent },
  { path: '**', redirectTo: '/' }, // Geçersiz url olması durumunda başlangıç sayfasına yönlendirir.
];
